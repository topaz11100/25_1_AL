...
$$
x\ge 16 \rightarrow
\frac{4}{ln 2} \cdot \frac{1}{x} \le \frac{4}{ln 2} \cdot \frac{1}{16} = \frac{1}{4 ln 2} = \frac{1}{ln 16} < 1
$$

$$
16 > e \approx 2.71828 \rightarrow ln 16 >1 \rightarrow \frac{1}{16} < 1 \rightarrow g'(x) > 0
$$
...
$$
N(c)=\lceil\max(16, 2log_{2}(\frac{1}{c}))\rceil
$$
